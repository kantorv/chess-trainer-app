...
const he: typeof en = {
  ...
  repertoires: {
    ...
    settings: {
      ...
      chanceArrows: "צביעת החיצים לפי סיכוי המשחק",
      chanceArrowsHelp:
        "הלוח נפתח ומצביע את החיצים לפי כמה שכיח שהמאמן משחק כל מסע — ירוק לכמעט תמיד, צהוב לכמעט אף פעם — בהסתעפויות שנושאות סימני סיכוי משחק. הסתעפות בלי סימנים שומרת על הירוק והכחול. אפשר עדיין לשנות זאת לסשן, ומשחקים תמיד מתחילים בלעדיה.",
      white: "לבן",
      black: "שחור",
      save: "שמירה",
      cancel: "ביטול",
    ...
    play: {
      ...
      chanceArrows: "צביעת החיצים לפי סיכוי המשחק",
      chanceArrowsHelp:
        "בהסתעפות שנושאת סימני סיכוי משחק, כל חץ מקבל צבע לפי כמה שכיח שהמאמן משחק את המסע הזה: ירוק לכמעט תמיד, צהוב לכמעט אף פעם.",
