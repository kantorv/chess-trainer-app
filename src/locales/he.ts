...
const he: typeof en = {
  ...
  savedAnalyses: {
    ...
    hint: "כל ניתוח שאתם שומרים בלוח הניתוח נשמר כאן — עם הווריאציות, ההערות והכול — ממוין לתיקיות שלכם. אפשר להמשיך אותו מהמקום שבו הופסק, או לקחת את העמדה למקום אחר.",
    storage:
