...
const he: typeof en = {
  ...
  repertoires: {
    ...
    settings: {
      ...
      chanceArrowsHelp:
        "בהסתעפויות שנושאות סימני סיכוי משחק, כל חץ נצבע לפי כמה שכיח שהמאמן משחק את המסע שלו — ירוק למסע הסביר ביותר, ענבר לחלופה אמיתית, אפור לכמעט אף פעם — וסרגל המסעים מדפיס את האחוז של כל מסע. הסתעפות בלי סימנים שומרת על הירוק והכחול. אפשר עדיין לשנות זאת לסשן, ומשחקים תמיד מתחילים בלעדיה.",
      white: "לבן",
      black: "שחור",
      save: "שמירה",
      cancel: "ביטול",
    ...
    play: {
      ...
      chanceArrows: "הצגת סיכויי המשחק",
      chanceArrowsHelp:
        "בהסתעפות שנושאת סימני סיכוי משחק: החיצים נצבעים לפי כמה שכיח שהמאמן משחק כל מסע — ירוק למסע הסביר ביותר, ענבר לחלופה אמיתית, אפור לכמעט אף פעם — וסרגל המסעים מדפיס את האחוז של כל מסע.",
