...
const he: typeof en = {
  ...
  repertoires: {
    ...
    changes: {
      ...
      copyName: "{{name}} (עותק)",
      protected: {
        title: "הרפרטואר הזה מוגן",
        body: "ההגדרות שלו מגינות עליו מפני שינויים. שמרו את השינויים כעותק — העותק אינו מוגן, כך שאפשר להמשיך לערוך אותו — או פתחו את ההגדרות שלו כדי לבטל את ההגנה. פתיחת ההגדרות יוצאת מהלוח הזה, והשינויים שלא נשמרו יאבדו.",
