/**
 * How big a saved list's preview card is — the two settings behind the
 * card-size toggle the saved screens share, and the grid track each one
 * produces.
 *
 * Its own module because the tests assert the grid template against these
 * numbers, and a component file that also exports values loses fast refresh
