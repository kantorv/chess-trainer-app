...
v2 screen since CTA-73 (Analysis v2, shipped), and Play with Engine, Masked
Pieces, the Openings explorer and the Library repertoire viewer are untouched by
it and stay the reference until their own issues.
