...
- **Picking and downloading a batch.** Every row carries a checkbox, and the
  ...
  not the URL. The top bar's own download icon is still the whole collection. The rows are **paged**
